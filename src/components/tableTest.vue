...
<script>
// import ElTableSelect from '../plugin/ElTableSelect/ElTableSelect'
// import ElSelectPro from '../plugin/ElSelectPro/ElSelectPro'
// import ElTableColumnPro from '../plugin/ElTableColumnPro/index'
import dataList from './data/test'
export default {
  components: {
    // ElTableSelect,
    // ElSelectPro,
